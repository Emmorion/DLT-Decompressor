...
public:
    ...
    void alterArgument(int index, QDltMsg& msg, const QString& text);
    void addNewArgument(int index, QDltMsg& msg, const QString& text);
    void arrayReplacement(int index, QDltMsg& msg, const QString& text);
